...
fig_scatter=px.scatter(x=df['number car accidents'],
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        #        id='btn-1',
        #        options=[{'label':'feature exploration','value':'feat'},
        #                 {'label':'neighborhood exploration','value':'nbhd'},],
        #        value='feat')],
